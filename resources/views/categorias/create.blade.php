      ...
      <div class="col-lg-9">
        ...
        <div class="container border">
          <div class="left p-4">
            ...
            <form class="form-horizontal" action="{{route('categorias.store')}}" method="POST" enctype="application/x-www-form-urlencoded">
                <div class=" form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Escribe el nombre de la categoría">
                </div>
                <div class="form-group">
